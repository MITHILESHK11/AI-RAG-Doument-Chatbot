...
def generate_answer_from_docs(docs, question, model_name="gemini-2.5-flash", temperature=0.2):
    if not docs:
...
def generate_theme_summary(docs, question, model_name="gemini-2.5-flash", temperature=0.5):
    if not docs:
